...
function loadDashboard() {
    // Update company count from localStorage if available
    const storedCompanies = localStorage.getItem('totalCompanies');
    if (storedCompanies) {
        statistics.totalCompanies = parseInt(storedCompanies);
    }
